...
#define RawSend(msg, size) while(!SystemCall(RAW_SEND, (unsigned int*)msg, size, 0))
#define RawReceive(msg) while(!SystemCall(RAW_RECEIVE, (unsigned int*)msg, 0, 0))
#define GetTaskPE(task_id) SystemCall(GETTASKPE, task_id, 0, 0)
